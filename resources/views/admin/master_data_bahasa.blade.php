        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="container">
                    <div class="row py-3">
                        <div class="col-md-6">
                            <button type="submit" class="btn shadow-sm" style="background-color: #CCFFD1">Tambah Tagihan
                                Semua</button>
                        </div>
                        <div class="col-md-6 text-end">
                            <a href="{{ url('masterdata') }}" class="btn btn-secondary">Semua</a>
                            <a href="{{ url('masterdata_bahasa') }}" class="btn btn-primary">Bahasa</a>
