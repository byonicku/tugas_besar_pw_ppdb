...
<head>
    ...
    <style>
        ...
        .custom-btn {
            background-color: #0C84A4; /* Background color */
...
<body>
    <div class="row" style="min-height: 100vh">
            ...
            <div class="d-flex flex-column py-5">
                ...
                <form action="{{ url('home') }}">
                    ...
                    <div class="mb-3 w-50 mx-auto">
                        ...
                        <input type="email" class="form-control py-2" id="email" name="email" placeholder="Email Pribadi" required>
                    </div>
                    <div class="mb-3 w-50 mx-auto">
                    ...
                    <div class="text-center pt-5">
                        <button type="submit" class="btn custom-btn px-5">Register</button>
                    </div>
                </form>
            </div>
        ...
        <div class="col-md-6 gradient" style="padding-top: 128px; padding-bottom: 40px;">
            <div class="d-flex flex-column py-5">
                <h1 style="color:#FFFFFF; font-size: 86px; max-width: 450px" class="align-self-center text-center pb-5">WELCOME TO SMATMA</h1>
                <a href="{{ url('register' )}}"
                    style="color: #FFFFFF; border: 1px solid #FFFFFF; font-size: 40px;"
